CREATE OR REPLACE FUNCTION
    `footprint-etl.Ethereum_ForTube_autoparse.Repay_event_function`(data STRING)
    RETURNS STRUCT<
    `user_address` STRING,
    `token_address` STRING,
    `cheque_token_address` STRING,
    `amount_repayed` STRING,
    ...
    var parsedEvent = {
        ...
        "inputs": [
            ...
            {"indexed": false, "internalType": "uint256", "name": "amount_repayed", "type": "uint256"},
