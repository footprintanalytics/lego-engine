...
FROM (SELECT
    ...
    ,`footprint-etl.BSC_ForTube_autoparse_beta.Withdraw_event_function`(logs.payload) AS parsed
FROM `footprint-etl.BSC_ForTube_autoparse_beta.MonitorEvent_event_bytes32Indexed_bytes` AS logs where FuncName='0x5769746864726177000000000000000000000000000000000000000000000000')
