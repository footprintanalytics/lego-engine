...
FROM (SELECT
    ...
    ,`footprint-etl.Ethereum_ForTube_autoparse.Withdraw_event_function`(logs.payload) AS parsed
FROM `footprint-etl.Ethereum_ForTube_autoparse.MonitorEvent_event_bytes32Indexed_bytes` AS logs where FuncName='0x5769746864726177000000000000000000000000000000000000000000000000')
