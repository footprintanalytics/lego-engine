...
FROM (SELECT
    ...
    ,`footprint-etl.Ethereum_ForTube_autoparse.WithdrawUnderlying_event_function`(logs.payload) AS parsed
    ,logs.log_index AS log_index
    ,logs.contract_address AS contract_address
FROM `footprint-etl.Ethereum_ForTube_autoparse.MonitorEvent_event_bytes32Indexed_bytes` AS logs where FuncName='0x5769746864726177556e6465726c79696e670000000000000000000000000000')