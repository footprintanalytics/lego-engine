SELECT
     ...
     ,parsed.amount_deposited AS `amount_deposited`
     ,parsed.underlying_deposited AS `underlying_deposited`
...
FROM (SELECT
    ...
    ,`footprint-etl.Ethereum_ForTube_autoparse.Deposit_event_function`(logs.payload) AS parsed
    ,logs.log_index AS log_index
    ,logs.contract_address AS contract_address
FROM `footprint-etl.Ethereum_ForTube_autoparse.MonitorEvent_event_bytes32Indexed_bytes` AS logs where FuncName='0x4465706f73697400000000000000000000000000000000000000000000000000')