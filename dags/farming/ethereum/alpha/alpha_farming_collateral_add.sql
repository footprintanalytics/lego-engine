with transactions as (
    ...
    where date(block_timestamp) >= '2021-04-29'
...
add_flow as (
    ...
    caller,
    from `footprint-etl.ethereum_alpha.HomoraBank_event_PutCollateral` as collateral
...
select * from (
    ...
    and add_flow.operator = token_transfer.from_address
    and add_flow.caller = token_transfer.to_address)
