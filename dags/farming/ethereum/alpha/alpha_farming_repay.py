...
class AlphaFarmingRepay(FarmingPositionModel):
    history_date = '2021-12-17'
    project_name = 'Alpha'
    task_name = 'alpha_farming_repay'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'farming/ethereum/alpha/alpha_farming_repay.sql'
    dataset_name_prefix = 'alpha'


if __name__ == '__main__':
    pool = AlphaFarmingRepay()
