...
transactions as (
    ...
    AND SUBSTR(input, 1, 10) IN ('0xb6b55f25', '0xd0e30db0', '0x6e553f65', '0xde5f6268')
...
from (
    ...
    ON (transactions.`hash` = tokenTransfer.transaction_hash and transactions.from_address = tokenTransfer.from_address and transactions.to_address = tokenTransfer.to_address)
)
where DATE(block_timestamp) {match_date_filter}
