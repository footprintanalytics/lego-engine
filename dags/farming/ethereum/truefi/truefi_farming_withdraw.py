...
class TruefiFarmingWithdraw(FarmingModel):
    history_date = '2021-12-16'
    project_name = 'Truefi'
    task_name = 'truefi_farming_withdraw'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'farming/ethereum/truefi/truefi_farming_withdraw.sql'
    dataset_name_prefix = 'truefi'


if __name__ == '__main__':
    pool = TruefiFarmingWithdraw()
