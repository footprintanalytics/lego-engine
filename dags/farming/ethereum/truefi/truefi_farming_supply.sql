...
from (
         select block_number,
                ...
                CAST(amountStaked as BIGNUMERIC) as asset_amount
         from `footprint-etl.ethereum_truefi.FarmTrueFi_event_Stake`
...
from `footprint-etl.ethereum_truefi.StakeTrueFi_event_Stake`
where Date (block_timestamp) {match_date_filter}
    )
