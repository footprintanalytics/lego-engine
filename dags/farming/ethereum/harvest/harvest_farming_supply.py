...
class HarvestFarmingSupply(FarmingModel):
    history_date = '2021-12-15'
    project_name = 'Harvest'
    task_name = 'harvest_farming_supply'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'farming/ethereum/harvest/harvest_farming_supply.sql'
    dataset_name_prefix = 'harvest'


if __name__ == '__main__':
    pool = HarvestFarmingSupply()
