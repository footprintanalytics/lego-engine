...
from farming import merge_all_farming_view
...
def history_farming_fixer(platform_class):
	pool = platform_class
	pool.run_daily_job()
	pool.parse_history_data()
...
if __name__ == '__main__':
	...
	"""执行demo"""
	from farming.ethereum.yearn import YearnFarmingWithdraw
	history_fixer(YearnFarmingWithdraw)
