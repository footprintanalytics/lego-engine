...
class PancakeswapFarmingWithdraw(FarmingModel):
    history_date = '2021-12-14'
    project_name = 'Pancakeswap'
    task_name = 'pancakeswap_farming_withdraw'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'farming/bsc/pancakeswap/pancakeswap_farming_withdraw.sql'
    dataset_name_prefix = 'pancakeswap'


if __name__ == '__main__':
    pool = PancakeswapFarmingWithdraw()
