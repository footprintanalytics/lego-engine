...
from fantom_event_etl.parse.templates import render_parse_udf_template, render_parse_sql_template, render_merge_template, render_stitch_view_template
...
def parse(
    ...
    dataset_name = 'fantom_' + table_definition['table']['dataset_name']
...
def get_source_table(
    ...
    partitioned_dataset_name = 'crypto_fantom'
