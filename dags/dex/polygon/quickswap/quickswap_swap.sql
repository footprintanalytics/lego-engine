...
FROM
    `footprint-etl.polygon_quickswap.UniswapV2Pair_event_Swap` t
INNER JOIN `footprint-etl.polygon_quickswap.UniswapV2Factory_event_PairCreated` f ON f.pair = t.contract_address
