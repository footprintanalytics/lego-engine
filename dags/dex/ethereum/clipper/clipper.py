...
class ClipperDex(DexModel):
    project_name = 'ethereum_dex_clipper'
    task_name = 'clipper_dex'
    task_liquidity_name = 'clipper_dex_liquidity'
    task_swap_name = 'clipper_dex_swap'
    # execution_time = '55 3 * * *'
    history_date = '2021-12-01'
    # source_liquidity_sql_file = 'dex/ethereum/clipper/liquidity.sql'
    source_swap_sql_file = 'dex/ethereum/clipper/swap.sql'
