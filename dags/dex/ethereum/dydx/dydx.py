...
class dydxDex(DexModel):
    project_name = 'ethereum_dex_dydx'
    task_name = 'dydx_dex'
    task_liquidity_name = 'dydx_dex_liquidity'
    task_swap_name = 'dydx_dex_swap'
    # execution_time = '55 3 * * *'
    history_date = '2021-12-01'
    # source_liquidity_sql_file = 'dex/ethereum/dydx/liquidity.sql'
    source_swap_sql_file = 'dex/ethereum/dydx/swap.sql'
