...
FROM
  (select
    *,
    '1' as version
    from
    blockchain-etl.ethereum_bancor.LiquidityPoolV1Converter_event_LiquidityRemoved
    UNION ALL
    select
    *,
    '2' as version
    from
    footprint-etl.ethereum_bancor.LiquidityPoolV2Converter_event_LiquidityRemoved
  ) a
