...
class linkswapDex(DexModel):
    project_name = 'ethereum_dex_linkswap'
    task_name = 'linkswap_dex'
    task_liquidity_name = 'linkswap_dex_liquidity'
    task_swap_name = 'linkswap_dex_swap'
    # execution_time = '55 3 * * *'
    history_date = '2021-12-01'
    # source_liquidity_sql_file = 'dex/ethereum/linkswap/liquidity.sql'
    source_swap_sql_file = 'dex/ethereum/linkswap/swap.sql'
