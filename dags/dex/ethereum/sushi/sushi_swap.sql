        ...
        FROM
            `blockchain-etl.ethereum_sushiswap.UniswapV2Pair_event_Swap` t
        INNER JOIN `blockchain-etl.ethereum_sushiswap.UniswapV2Factory_event_PairCreated` f ON f.pair = t.contract_address
