...
class RaricapitalLendingLiquidation(LendingModel):
    history_date = '2021-12-12'
    project_name = 'Raricapital'
    task_name = 'raricapital_lending_liquidation'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/raricapital/raricapital_lending_liquidation.sql'
