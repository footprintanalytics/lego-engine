                ...
                from`footprint-etl.ethereum_raricapital.CErc20Delegator_event_RepayBorrow` b
                left join `footprint-blockchain-etl.crypto_ethereum.token_transfers` f
                on f.transaction_hash=b.transaction_hash and b.contract_address=f.to_address and f.value=b.repayAmount
