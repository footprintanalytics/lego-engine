...
class TruefiLendingRepay(LendingModel):
    history_date = '2021-12-12'
    project_name = 'Truefi'
    task_name = 'truefi_lending_repay'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/truefi/truefi_lending_repay.sql'
    dataset_name_prefix = 'truefi'


if __name__ == '__main__':
    pool = TruefiLendingRepay()
