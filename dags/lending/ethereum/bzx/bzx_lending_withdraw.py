...
class BzxLendingWithdraw(LendingModel):
    history_date = '2021-12-12'
    project_name = 'Bzx'
    task_name = 'bzx_lending_withdraw'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/bzx/bzx_lending_withdraw.sql'
    dataset_name_prefix = 'bzx'


if __name__ == '__main__':
    pool = BzxLendingWithdraw()
