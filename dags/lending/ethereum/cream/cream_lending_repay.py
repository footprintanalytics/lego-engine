...
class CreamLendingRepay(LendingModel):
    history_date = '2021-12-12'
    project_name = 'Cream'
    task_name = 'cream_lending_repay'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/cream/cream_lending_repay.sql'
    dataset_name_prefix = 'cream'


if __name__ == '__main__':
    pool = CreamLendingRepay()
