...
class CompoundLendingRepay(LendingModel):
    history_date = '2021-12-15'
    project_name = 'Compound'
    task_name = 'compound_lending_repay'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/compound/compound_lending_repay.sql'
    dataset_name_prefix = 'compound'


if __name__ == '__main__':
    pool = CompoundLendingRepay()
