...
class CompoundLendingWithdraw(LendingModel):
    history_date = '2021-12-15'
    project_name = 'Compound'
    task_name = 'compound_lending_withdraw'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/compound/compound_lending_withdraw.sql'
    dataset_name_prefix = 'compound'


if __name__ == '__main__':
    pool = CompoundLendingWithdraw()
