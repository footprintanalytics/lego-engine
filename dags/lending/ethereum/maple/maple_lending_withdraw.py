...
class MapleLendingWithdraw(LendingModel):
    history_date = '2021-12-12'
    project_name = 'Maple'
    task_name = 'maple_lending_withdraw'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'lending/ethereum/maple/maple_lending_withdraw.sql'
    dataset_name_prefix = 'maple'


if __name__ == '__main__':
    pool = MapleLendingWithdraw()
