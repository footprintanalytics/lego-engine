...
from lending.create_all_view import merge_all_lending_view, all_project
...
if __name__ == '__main__':
	# Parallel(n_jobs=4)(delayed(history_fixer_all)(item) for item in tqdm(all_project))

	"""执行demo"""
	from lending.ethereum.maple import MapleLendingSupply
	history_fixer(MapleLendingSupply)
