...
class VenusLendingRepay(LendingModelBsc):
    project_name = 'bsc_venus'
    task_name = 'bsc_venus_lending_repay'
    source_event_sql_file = 'lending/bsc/venus/venus_lending_repay.sql'
    dataset_name_prefix = 'venus'
    history_date = '2021-12-19'


if __name__ == '__main__':
    lending = VenusLendingRepay()
