...
FROM (
         ...
         from footprint-etl.ethereum_abracadabra.BentoBoxV1_event_LogDeposit as dep
	     inner join footprint-etl.ethereum_abracadabra.CauldronLowRiskV1_event_LogBorrow as bor
         ...
         select
             ...
             dep.amount as asset_amount
         from footprint-etl.ethereum_abracadabra.BentoBoxV1_event_LogDeposit as dep
             inner join footprint-etl.ethereum_abracadabra.CauldronV2Flat_event_LogBorrow as bor
         on dep.transaction_hash = bor.transaction_hash
     ) repay
