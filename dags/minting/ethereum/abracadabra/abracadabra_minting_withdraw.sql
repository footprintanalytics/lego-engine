...
FROM (
         ...
         from footprint-etl.ethereum_abracadabra.BentoBoxV1_event_LogWithdraw as wtd
	     inner join footprint-etl.ethereum_abracadabra.CauldronLowRiskV1_event_LogRepay as rep
         ...
         select
             ...
             wtd.amount as asset_amount
         from footprint-etl.ethereum_abracadabra.BentoBoxV1_event_LogWithdraw as wtd
             inner join footprint-etl.ethereum_abracadabra.CauldronV2Flat_event_LogRepay as rep
         on wtd.transaction_hash = rep.transaction_hash
     ) withdraw
