...
class MakerMintingBorrow(MintingBorrowModel):
    history_date = '2021-12-12'
    project_name = 'Maker'
    task_name = 'maker_minting_borrow'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'minting/ethereum/maker/maker_minting_borrow.sql'
    dataset_name_prefix = 'maker'


if __name__ == '__main__':
    pool = MakerMintingBorrow()
