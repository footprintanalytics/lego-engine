...
class FraxMintingBorrow(MintingBorrowModel):
    history_date = '2021-12-12'
    project_name = 'Frax'
    task_name = 'frax_minting_borrow'
    execution_time = '5 3 * * *'
    source_event_sql_file = 'minting/ethereum/frax/frax_minting_borrow.sql'
    dataset_name_prefix = 'frax'


if __name__ == '__main__':
    pool = FraxMintingBorrow()
