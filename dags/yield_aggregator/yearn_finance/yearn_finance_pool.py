...
class YearnFinancePool(InvestPoolModel1):
    project_name = 'Yearn-Finance'
    task_name = 'yearn_finance_pool_transactions'
    execution_time = '5 3 * * *'
    history_date = '2021-11-15'

    token_config = {
        "csv_file_path": 'yield_aggregator/yearn_finance/yearn_finance_pools.csv',
