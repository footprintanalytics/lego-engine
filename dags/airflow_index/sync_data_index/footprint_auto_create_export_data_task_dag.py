...
from doris_load.auto_create_export_data_task import auto_create_export_data_task
...
dag_params = {
    "dag_id": "footprint_auto_create_export_data_task_dag",
    "catchup": False,
...
dag_task_params = [
    {
        "task_id": "auto_create_export_data_task",
