from validation.basic_validate.abnormal_number_validate import AbnormalNumberValidate


class DexLiquidityAbnormalNumberValidate(AbnormalNumberValidate):
