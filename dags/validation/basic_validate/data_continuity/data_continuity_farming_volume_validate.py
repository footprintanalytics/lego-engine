...
class DataContinuityFarmingVolumeValidate(DataContinuityValidate):
    validate_name = 'data_continuity_farming_volume_validate'
    desc = 'farming业务的volume的连续性校验'
