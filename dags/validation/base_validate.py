...
class BaseValidate:
    ...
    def __init__(self, cfg):
        ...
        if 'slack_warn' in cfg:
            self.slack_warn = cfg['slack_warn']
        if 'business_type' in cfg:
            self.business_type = cfg['business_type']
    ...
    def save_db(self, result: dict, time_result: dict):
        ...
        slack_warn = self.slack_warn and self.project in self.need_warn_project_list
